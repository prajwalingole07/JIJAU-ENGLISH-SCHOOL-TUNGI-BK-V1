      ...
      <div className="space-y-6">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          ...
          {isPrivileged && (
            <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
              ...
              <DialogContent className="fixed left-[50%] top-[50%] z-[150] translate-x-[-50%] translate-y-[-50%] bg-background p-0 shadow-lg sm:rounded-lg max-h-[90vh] overflow-hidden max-w-md w-[95vw] flex flex-col border-none">
                <DialogHeader className="p-6 md:p-8 shrink-0 bg-white border-b">
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-8 no-scrollbar scroll-touch">
                  <form id="create-portal-form" onSubmit={handleCreatePortal} className="space-y-6">
                ...
                <DialogFooter className="p-6 md:p-8 border-t shrink-0 bg-white">
                  <Button form="create-portal-form" type="submit" className="w-full bg-[#1F58B3] h-14 rounded-xl font-black text-lg gap-3">
                          ...
                          <div className="flex items-center justify-end gap-2">
                            ...
                            {t.username && (
                              <AlertDialog>
                                ...
                                <AlertDialogContent className="z-[200] w-[95vw] max-w-md rounded-2xl">
                                  <AlertDialogHeader>
        ...
        <Dialog open={isEditOpen} onOpenChange={setIsEditOpen}>
          <DialogContent className="fixed left-[50%] top-[50%] z-[150] translate-x-[-50%] translate-y-[-50%] bg-background p-0 shadow-lg sm:rounded-lg max-h-[90vh] overflow-hidden max-w-md w-[95vw] flex flex-col border-none">
            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-8 no-scrollbar scroll-touch">
              <form id="edit-portal-form" onSubmit={handleUpdatePortal} className="space-y-6">
                <div className="space-y-4">
                  <div className="space-y-2">
                    <Label className="text-[11px] font-black uppercase text-gray-400 tracking-widest">Portal Username / ID</Label>
                    <Input 
            ...
            <DialogFooter className="p-6 md:p-8 border-t shrink-0 bg-white">
              <Button form="edit-portal-form" type="submit" className="w-full bg-[#1F58B3] h-14 rounded-xl font-black text-lg gap-3 shadow-lg shadow-blue-100">
