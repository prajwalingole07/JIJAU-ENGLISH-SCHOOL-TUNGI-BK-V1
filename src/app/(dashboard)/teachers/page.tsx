      ...
      <div className="space-y-6">
            ...
            <Dialog open={isAddOpen} onOpenChange={(val) => { setIsAddOpen(val); if (!val) resetForm(); }}>
              ...
              <DialogContent className="max-w-2xl w-[95vw] md:w-full rounded-[2rem] p-0 flex flex-col max-h-[90vh] overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-6 md:p-8 pt-0 no-scrollbar">
                  <form id="faculty-enrollment-form" onSubmit={handleSubmit} className="space-y-4">
                ...
                <DialogFooter className="p-6 md:p-8 border-t shrink-0">
                  <Button form="faculty-enrollment-form" type="submit" className="w-full bg-[#1F58B3] h-12 font-bold rounded-xl shadow-lg">
        ...
        <Dialog open={isEditOpen} onOpenChange={(val) => { setIsEditOpen(val); if (!val) resetForm(); }}>
          <DialogContent className="max-w-2xl w-[95vw] md:w-full rounded-[2rem] p-0 flex flex-col max-h-[90vh] overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-6 md:p-8 pt-0 no-scrollbar">
              <form id="faculty-edit-form" onSubmit={handleSubmit} className="space-y-4">
                <DirectoryFormFields formData={formData} setFormData={setFormData} handleFileChange={handleFileChange} fileInputRef={fileInputRef} isPrivileged={isPrivileged} />
              </form>
            </div>
            <DialogFooter className="p-6 md:p-8 border-t shrink-0">
              <Button form="faculty-edit-form" type="submit" className="w-full bg-[#1F58B3] h-12 font-bold rounded-xl shadow-lg">
                Save Changes
              </Button>
            </DialogFooter>
          </DialogContent>
